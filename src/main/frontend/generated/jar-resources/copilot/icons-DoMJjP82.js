...
function i(e) {
	process.env.NODE_ENV !== "production" && G.verifyProxies && t("MobX is currently configured to be able to run in ES5 mode, but in ES5 MobX won't be able to " + e);
}
function a() {
	return ++G.mobxGuid;
}
...
function Ne(e, t, n, r, i) {
	var a, o;
	i === void 0 && (i = G.safeDescriptors), Me(e, t, n, r);
	var s = r.value;
...
function ze(e, t, n, r, i, a) {
	a === void 0 && (a = G.safeDescriptors), Re(e, t, n, r);
	var o = r.value;
...
function Ue(e, t) {
	...
	return i(function() {
		...
		i.name ||= process.env.NODE_ENV === "production" ? "ObservableObject." + r.toString() : t.name_ + "." + r.toString(), t.values_.set(r, new H(i));
	}), function() {
...
function Je(e, n) {
	...
	function s(e, t) {
		var n = bn(e)[R], i = new V(t, r.options_?.enhancer ?? Ce, process.env.NODE_ENV === "production" ? "ObservableObject." + a.toString() : n.name_ + "." + a.toString(), !1);
...
function st(e, t, n, r) {
	...
	var o = G.trackingDerivation, s = !t || !o;
	C();
	var c = G.allowStateChanges;
	s && (bt(), c = ut(!0));
	var l = xt(!0), u = {
		runAsAction_: s,
		prevDerivation_: o,
...
function ct(e) {
	yr !== e.actionId_ && t(30), yr = e.parentActionId_, e.error_ !== void 0 && (G.suppressReactionErrors = !0), dt(e.prevAllowStateChanges_), St(e.prevAllowStateReads_), w(), e.runAsAction_ && S(e.prevDerivation_), process.env.NODE_ENV !== "production" && e.notifySpy_ && D({ time: Date.now() - e.startTime_ }), G.suppressReactionErrors = !1;
}
function lt(e, t) {
	var n = ut(e);
	try {
	...
	switch (e.dependenciesState_) {
		...
		case U.POSSIBLY_STALE_:
			for (var t = xt(!0), n = bt(), r = e.observing_, i = r.length, a = 0; a < i; a++) {
				var o = r[a];
				if (wr(o)) {
					if (G.disableErrorBoundaries) o.get();
					else try {
						o.get();
					} catch {
						return S(n), St(t), !0;
					}
					if (e.dependenciesState_ === U.STALE_) return S(n), St(t), !0;
				}
			}
...
function ht(e, t, n) {
	var r = xt(!0);
	Ct(e), e.newObserving_ = Array(e.runId_ === 0 ? 100 : e.observing_.length), e.unboundDepsCount_ = 0, e.runId_ = ++G.runId;
	var i = G.trackingDerivation;
	G.trackingDerivation = e, G.inBatch++;
	var a;
	if (G.disableErrorBoundaries === !0) a = t.call(n);
	else try {
		a = t.call(n);
	} catch (e) {
		a = new Tr(e);
	}
	return G.inBatch--, G.trackingDerivation = i, _t(e), gt(e), St(r), a;
}
function gt(e) {
...
function _t(e) {
	for (var t = e.observing_, n = e.observing_ = e.newObserving_, r = U.UP_TO_DATE_, i = 0, a = e.unboundDepsCount_, o = 0; o < a; o++) {
		var s = n[o];
...
function Ct(e) {
	if (e.dependenciesState_ !== U.UP_TO_DATE_) {
		...
		for (var t = e.observing_, n = t.length; n--;) t[n].lowestObserverState_ = U.UP_TO_DATE_;
	}
}
function wt(e, t) {
...
function w() {
	if (--G.inBatch === 0) {
		...
		for (var e = G.pendingUnobservations, t = 0; t < e.length; t++) {
			var n = e[t];
			n.isPendingUnobservation = !1, n.observers_.size === 0 && (n.isBeingObserved && (n.isBeingObserved = !1, n.onBUO()), n instanceof H && n.suspend_());
		}
...
function Dt(e) {
	...
	return t === null ? (e.observers_.size === 0 && G.inBatch > 0 && Et(e), !1) : (t.runId_ !== e.lastAccessedBy_ && (e.lastAccessedBy_ = t.runId_, t.newObserving_[t.unboundDepsCount_++] = e, !e.isBeingObserved && G.trackingContext && (e.isBeingObserved = !0, e.onBO())), e.isBeingObserved);
}
function Ot(e) {
	e.lowestObserverState_ !== U.STALE_ && (e.lowestObserverState_ = U.STALE_, e.observers_.forEach(function(t) {
		t.dependenciesState_ === U.UP_TO_DATE_ && (process.env.NODE_ENV !== "production" && t.isTracing_ !== W.NONE && jt(t, e), t.onBecomeStale_()), t.dependenciesState_ = U.STALE_;
	}));
}
function kt(e) {
	e.lowestObserverState_ !== U.STALE_ && (e.lowestObserverState_ = U.STALE_, e.observers_.forEach(function(t) {
		t.dependenciesState_ === U.POSSIBLY_STALE_ ? (t.dependenciesState_ = U.STALE_, process.env.NODE_ENV !== "production" && t.isTracing_ !== W.NONE && jt(t, e)) : t.dependenciesState_ === U.UP_TO_DATE_ && (e.lowestObserverState_ = U.UP_TO_DATE_);
	}));
}
function At(e) {
	e.lowestObserverState_ === U.UP_TO_DATE_ && (e.lowestObserverState_ = U.POSSIBLY_STALE_, e.observers_.forEach(function(e) {
		e.dependenciesState_ === U.UP_TO_DATE_ && (e.dependenciesState_ = U.POSSIBLY_STALE_, e.onBecomeStale_());
	}));
}
function jt(e, t) {
...
function Nt(e) {
	return G.globalReactionErrorHandlers.push(e), function() {
		var t = G.globalReactionErrorHandlers.indexOf(e);
		t >= 0 && G.globalReactionErrorHandlers.splice(t, 1);
	};
}
function Pt() {
	G.inBatch > 0 || G.isRunningReactions || Ar(Ft);
}
function Ft() {
	G.isRunningReactions = !0;
	for (var e = G.pendingReactions, t = 0; e.length > 0;) {
		++t === kr && (console.error(process.env.NODE_ENV === "production" ? "[mobx] cycle in reaction: " + e[0] : "Reaction doesn't converge to a stable state after " + kr + " iterations." + (" Probably there is a cycle in the reactive function: " + e[0])), e.splice(0));
...
function It(e) {
	if (process.env.NODE_ENV !== "production" && G.spyListeners.length) for (var t = G.spyListeners, n = 0, r = t.length; n < r; n++) t[n](e);
}
function E(e) {
...
function Lt(e) {
	return process.env.NODE_ENV === "production" ? (console.warn("[mobx.spy] Is a no-op in production builds"), function() {}) : (G.spyListeners.push(e), o(function() {
...
function Rt(e) {
	return function(n, r) {
		if (s(n)) return at(n.name || Lr, n, e);
		if (s(r)) return at(n, r, e);
		if (ge(r)) return (e ? Br : Rr).decorate_20223_(n, r);
		if (c(r)) return me(n, r, e ? Br : Rr);
		if (c(n)) return b(Oe(e ? Fr : Nr, {
			name: n,
			autoAction: e
		}));
...
function zt(e) {
	return ot(e.name || Lr, !1, e, this, void 0);
}
function Bt(e) {
...
function Ut(e, n, r) {
	...
	var o = r.name ?? (process.env.NODE_ENV === "production" ? "Reaction" : "Reaction@" + a()), c = Hr(o, r.onError ? Wt(r.onError, n) : n), l = !r.scheduler && !r.delay, d = Ht(r), f = !0, ee = !1, p, m = r.compareStructural ? er.structural : r.equals || er.default, h = new K(o, function() {
		f || l ? g() : ee || (ee = !0, d(g));
...
function tn(e, n) {
	return e ? n === void 0 ? Sn(e) || !!e[R] || $n(e) || jr(e) || wr(e) : process.env.NODE_ENV !== "production" && (Y(e) || gn(e)) ? t("isObservable(object, propertyName) is not supported for arrays and maps. Use map.has or array.length instead.") : Sn(e) ? e[R].values_.has(n) : !1 : !1;
}
function nn(e) {
...
function sn() {
	if (process.env.NODE_ENV !== "production") {
		...
		r.isTracing_ === W.NONE && console.log("[mobx.trace] '" + r.name_ + "' tracing enabled"), r.isTracing_ = e ? W.BREAK : W.LOG;
	}
}
function cn(e) {
	switch (e.length) {
		case 0: return G.trackingDerivation;
...
function An(e, n) {
	if (typeof e == "object" && e) {
		...
		if ($n(e) || wr(e) || jr(e)) return e;
	} else if (s(e) && jr(e[R])) return e[R];
	t(28);
}
function jn(e, n) {
	if (e || t(29), n !== void 0) return jn(An(e, n));
	if ($n(e) || wr(e) || jr(e) || Y(e) || X(e)) return e;
	if (e[R]) return e[R];
	t(24, e);
}
function Mn(e, t) {
...
var Bn, Vn, Hn, Un, I, Wn, Gn, Kn, qn, Jn, Yn, Xn, Zn, Qn, L, R, z, $n, er, tr, nr, rr, ir, ar, or, sr, cr, lr, ur, dr, fr, pr, B, mr, hr, gr, _r, vr, yr, br, xr, Sr, Cr, V, H, wr, U, W, Tr, Er, Dr, Or, G, K, kr, Ar, jr, Mr, Nr, Pr, Fr, Ir, Lr, Rr, zr, Br, Vr, Hr, Ur, Wr, Gr, Kr, qr, Jr, Yr, Xr, Zr, Qr, $r, q, ei, ti, ni, ri, ii, ai, J, oi, si, Y, ci, li, X, ui, di, fi, pi, mi, hi, gi, _i, vi, yi, bi, xi = e((() => {
	Bn = process.env.NODE_ENV === "production" ? {} : {
		...
		function e(e) {
			e === void 0 && (e = process.env.NODE_ENV === "production" ? "Atom" : "Atom@" + a()), this.name_ = void 0, this.flags_ = 0, this.observers_ = /* @__PURE__ */ new Set(), this.lastAccessedBy_ = 0, this.lowestObserverState_ = U.NOT_TRACKING_, this.onBOL = void 0, this.onBUOL = void 0, this.name_ = e;
		}
		var t = e.prototype;
		...
		box: function(e, t) {
			var n = et(t);
			return new V(e, tt(n), n.name, !0, n.equals);
		},
		array: function(e, t) {
			var n = et(t);
			return (G.useProxies === !1 || n.proxy === !1 ? kn : mn)(e, tt(n), n.name);
		},
		map: function(e, t) {
			var n = et(t);
		...
		object: function(e, t, n) {
			return Nn(function() {
				return Jt(G.useProxies === !1 || n?.proxy === !1 ? bn({}, n) : un({}, n), e, t);
			});
		},
		ref: /* @__PURE__ */ b(ur),
		...
		return n.dehanceValue = function(e) {
			...
			var t = this.value_;
			if (e = this.prepareNewValue_(e), e !== G.UNCHANGED) {
				var n = T();
			...
			if (x(this), k(this)) {
				...
				if (!t) return G.UNCHANGED;
				e = t.newValue;
			}
			return e = this.enhancer(e, this.value_, this.name_), this.equals(this.value_, e) ? G.UNCHANGED : e;
		...
		return n.onBecomeStale_ = function() {
			...
			if (this.isComputing && t(32, this.name_, this.derivation), G.inBatch === 0 && this.observers_.size === 0 && !this.keepAlive_) pt(this) && (this.warnAboutUntrackedRead_(), C(), this.value_ = this.computeValue_(!1), w());
			else if (Dt(this), pt(this)) {
				var e = G.trackingContext;
				this.keepAlive_ && !e && (G.trackingContext = this), this.trackAndCompute() && kt(this), G.trackingContext = e;
			}
			var n = this.value_;
			...
			var e = this.value_, t = this.dependenciesState_ === U.NOT_TRACKING_, n = this.computeValue_(!0), r = t || ft(e) || ft(n) || !this.equals_(e, n);
			...
			else if (G.disableErrorBoundaries === !0) n = this.derivation.call(this.scope_);
			else try {
			...
			this.keepAlive_ || (vt(this), this.value_ = void 0, process.env.NODE_ENV !== "production" && this.isTracing_ !== W.NONE && console.log("[mobx.trace] Computed value '" + this.name_ + "' was suspended and it will recompute on the next access."));
		}, n.observe_ = function(e, t) {
			...
			process.env.NODE_ENV !== "production" && (this.isTracing_ !== W.NONE && console.log("[mobx.trace] Computed value '" + this.name_ + "' is being read outside a reactive context. Doing a full recompute."), (typeof this.requiresReaction_ == "boolean" ? this.requiresReaction_ : G.computedRequiresReaction) && console.warn("[mobx] Computed value '" + this.name_ + "' is being read outside a reactive context. Doing a full recompute."));
		}, n.toString = function() {
	...
	}(), H.isComputingMask_ = 1, H.isRunningSetterMask_ = 2, H.isBeingObservedMask_ = 4, H.isPendingUnobservationMask_ = 8, H.diffValueMask_ = 16, wr = /* @__PURE__ */ p("ComputedValue", H), (function(e) {
	...
	}, Dr = !0, Or = !1, G = /* @__PURE__ */ function() {
		var e = /* @__PURE__ */ n();
		return e.__mobxInstanceCount > 0 && !e.__mobxGlobals && (Dr = !1), e.__mobxGlobals && e.__mobxGlobals.version !== new Er().version && (Dr = !1), Dr ? e.__mobxGlobals ? (e.__mobxInstanceCount += 1, e.__mobxGlobals.UNCHANGED || (e.__mobxGlobals.UNCHANGED = {}), e.__mobxGlobals) : (e.__mobxInstanceCount = 1, e.__mobxGlobals = /* @__PURE__ */ new Er()) : (setTimeout(function() {
			Or || t(35);
		}, 1), new Er());
	}(), K = /* @__PURE__ */ function() {
		function e(e, t, n, r) {
			e === void 0 && (e = process.env.NODE_ENV === "production" ? "Reaction" : "Reaction@" + a()), this.name_ = void 0, this.onInvalidate_ = void 0, this.errorHandler_ = void 0, this.requiresObservable_ = void 0, this.observing_ = [], this.newObserving_ = [], this.dependenciesState_ = U.NOT_TRACKING_, this.runId_ = 0, this.unboundDepsCount_ = 0, this.flags_ = 0, this.isTracing_ = W.NONE, this.name_ = e, this.onInvalidate_ = t, this.errorHandler_ = n, this.requiresObservable_ = r;
		}
		var t = e.prototype;
		return t.onBecomeStale_ = function() {
			this.schedule_();
		}, t.schedule_ = function() {
			this.isScheduled || (this.isScheduled = !0, G.pendingReactions.push(this), Pt());
		}, t.runReaction_ = function() {
			if (!this.isDisposed) {
				C(), this.isScheduled = !1;
				var e = G.trackingContext;
				if (G.trackingContext = this, pt(this)) {
			...
			if (!this.isDisposed) {
				...
				G.trackingContext = r, this.isRunning = !1, this.isTrackPending = !1, this.isDisposed && vt(this), ft(i) && this.reportExceptionInDerivation_(i.cause), process.env.NODE_ENV !== "production" && t && D({ time: Date.now() - n }), w();
			}
			...
			if (G.disableErrorBoundaries) throw e;
			...
			G.suppressReactionErrors ? process.env.NODE_ENV !== "production" && console.warn("[mobx] (error in reaction '" + this.name_ + "' suppressed, fix error of causing action below)") : console.error(n, e), process.env.NODE_ENV !== "production" && T() && It({
				type: "error",
				name: this.name_,
				message: n,
				error: "" + e
			}), G.globalReactionErrorHandlers.forEach(function(n) {
				return n(e, t);
			});
		}, t.dispose = function() {
	...
	}(), K.isDisposedMask_ = 1, K.isScheduledMask_ = 2, K.isTrackPendingMask_ = 4, K.isRunningMask_ = 8, K.diffValueMask_ = 16, kr = 100, Ar = function(e) {
		return e();
	}, jr = /* @__PURE__ */ p("Reaction", K), Mr = {
		type: "report-end",
		spyReportEnd: !0
	}, Nr = "action", Pr = "action.bound", Fr = "autoAction", Ir = "autoAction.bound", Lr = "<unnamed action>", Rr = /* @__PURE__ */ Oe(Nr), zr = /* @__PURE__ */ Oe(Pr, { bound: !0 }), Br = /* @__PURE__ */ Oe(Fr, { autoAction: !0 }), Vr = /* @__PURE__ */ Oe(Ir, {
		autoAction: !0,
		bound: !0
	}), Hr = /* @__PURE__ */ Rt(!1), Object.assign(Hr, Rr), Ur = /* @__PURE__ */ Rt(!0), Object.assign(Ur, Br), Hr.bound = /* @__PURE__ */ b(zr), Ur.bound = /* @__PURE__ */ b(Vr), Wr = function(e) {
		return e();
		...
		var r = e, i = r.name || "<unnamed flow>", a = function() {
			var e = this, t = arguments, n = ++qr, a = Hr(i + " - runid: " + n + " - init", r).apply(e, t), o, c = void 0, l = new Promise(function(e, t) {
				var r = 0;
				o = t;
				function l(e) {
					c = void 0;
					var o;
					try {
						o = Hr(i + " - runid: " + n + " - yield " + r++, a.next).call(a, e);
					} catch (e) {
						return t(e);
					}
					d(o);
				...
				function u(e) {
					...
					var o;
					try {
						o = Hr(i + " - runid: " + n + " - yield " + r++, a.throw).call(a, e);
					} catch (e) {
						return t(e);
					}
					d(o);
			...
			return l.cancel = Hr(i + " - runid: " + n + " - cancel", function() {
				try {
					c && $t(c);
		...
		has: function(e, t) {
			return process.env.NODE_ENV !== "production" && G.trackingDerivation && i("detect new properties using the 'in' operator. Use 'has' from 'mobx' instead."), ln(e).has_(t);
		},
		get: function(e, t) {
			return ln(e).get_(t);
		},
		...
		ownKeys: function(e) {
			return process.env.NODE_ENV !== "production" && G.trackingDerivation && i("iterate keys to detect added / removed properties. Use 'keys' from 'mobx' instead."), ln(e).ownKeys_();
		},
		...
		reverse: function() {
			return G.trackingDerivation && t(37, "reverse"), this.replace(this.slice().reverse()), this;
		},
		sort: function() {
			G.trackingDerivation && t(37, "sort");
			var e = this.slice();
		...
		return n.has_ = function(e) {
			...
			var t = this;
			if (!G.trackingDerivation) return this.has_(e);
			var n = this.hasMap_.get(e);
			if (!n) {
				var r = n = new V(this.has_(e), Te, process.env.NODE_ENV === "production" ? "ObservableMap.key?" : this.name_ + "." + ne(e) + "?", !1);
			...
			if (t = n.prepareNewValue_(t), t !== G.UNCHANGED) {
			...
			x(this.keysAtom_), O(function() {
				var r, i = new V(t, n.enhancer_, process.env.NODE_ENV === "production" ? "ObservableMap.key" : n.name_ + "." + ne(e), !1);
		...
		return n.getObservablePropValue_ = function(e) {
			...
			if (n instanceof H) return n.set(t), !0;
			if (k(this)) {
				var r = A(this, {
					type: q,
			...
			return G.trackingDerivation && !_(this.target_, e) && this.has_(e), this.target_[e];
			...
			if (!G.trackingDerivation) return e in this.target_;
			this.pendingKeys_ ||= /* @__PURE__ */ new Map();
			var t = this.pendingKeys_.get(e);
			return t || (t = new V(e in this.target_, Te, process.env.NODE_ENV === "production" ? "ObservableObject.key?" : this.name_ + "." + ne(e) + "?", !1), this.pendingKeys_.set(e, t)), t.get();
			...
			try {
				...
				var c = new V(t, n, process.env.NODE_ENV === "production" ? "ObservableObject.key" : this.name_ + "." + e.toString(), !1);
			...
			try {
				...
				this.values_.set(e, new H(t)), this.notifyPropertyAddition_(e, void 0);
			} finally {
				w();
			}
			return !0;
			...
			try {
				...
				if (process.env.NODE_ENV !== "production" && delete this.appliedAnnotations_[e], a && (this.values_.delete(e), a instanceof V && (o = a.value_), Ot(a)), this.keysAtom_.reportChanged(), (n = this.pendingKeys_) == null || (n = n.get(e)) == null || n.set(e in this.target_), r || i) {
					var s = {
						type: di,
						observableKind: "object",
						object: this.proxy_ || this.target_,
...
//#endregion
export { Ci as $, ga as A, na as B, ja as C, wa as D, Da as E, _a as F, ra as G, $i as H, va as I, la as J, Ki as K, da as L, ha as M, ya as N, ba as O, fa as P, wi as Q, ua as R, Oa as S, Ea as T, Zi as U, Qi as V, ia as W, oa as X, sa as Y, aa as Z, Na as _, Go as a, pn as at, Ta as b, Uo as c, Nt as ct, ro as d, Ei as et, oo as f, Pa as g, Ba as h, Jo as i, xi as it, pa as j, ma as k, Ko as l, Ut as lt, Va as m, es as n, K as nt, $ as o, B as ot, no as p, Gi as q, Qo as r, Vt as rt, jo as s, rn as st, $o as t, Si as tt, Ao as u, zt as ut, xa as v, Ca as w, ka as x, Sa as y, Ui as z };
