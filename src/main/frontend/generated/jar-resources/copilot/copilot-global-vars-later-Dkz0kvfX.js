...
import { A as t, J as n, K as r, L as i, N as a, P as ee, R as o, _ as s, a as c, at as l, g as u, it as d, n as f, o as p, ot as te, q as m, r as h, t as g, u as _ } from "./icons-DoMJjP82.js";
import { l as v, o as y } from "./consts-nuhLqR24.js";
import { c as b, g as x } from "./dom-utils-BVcG3axi.js";
import { a as S, n as C, o as w, t as T } from "./copilot-tree-impl-Dw-Rk5hX.js";
import { n as E, t as D } from "./copilot-eventbus-tR06exIW.js";
import { i as O, n as k } from "./copilot-server-communicator-impl-COKJGGMW.js";
import { a as A, i as j, t as M } from "./stats-BSuRK33k.js";
import { i as N, o as P } from "./copilot-error-handler-DrF5aMdz.js";
...
var R = e((() => {
	a(), n(), v(), E(), u(), M(), D.on("show-in-ide", (e) => {
		let t = e.detail.node;
		if (e.detail.source) {
			F(e.detail.source);
			return;
...
var G, K = e((() => {
	i(), P(), f(), h(), G = "vaadin.copilot.viewCreated";
})), q, J = e((() => {
	E(), q = class {
		constructor(e) {
			this._currentTree = e;
...
var Z = e((() => {})), Q, ne = e((() => {
	h(), f(), d(), w(), Z(), b(), Q = class e {
		constructor() {
			this.drillDownComponentStack = [], l(this, { drillDownComponentStack: te.shallow });
		}
		getCustomComponentIcon(e) {
			let t = this.getIconTag(e);
			return t === void 0 ? p : g[t];
		}
		getIconTag(e) {
		...
		getParentDrillDownContext() {
			if (this.hasParentDrillDownContext()) return this.drillDownComponentStack[this.drillDownComponentStack.length - 2];
		}
		...
		restoreDrillDownFromStorage() {
			...
			let r = this.getActiveDrillDownContext();
			r && x(r);
		}
