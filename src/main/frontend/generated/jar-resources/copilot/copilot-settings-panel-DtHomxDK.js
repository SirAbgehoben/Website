...
import { L as t, Q as n, R as r, et as i, n as a, o, r as s, t as c, u as l } from "./icons-DoMJjP82.js";
import { l as u, o as d } from "./consts-nuhLqR24.js";
import { a as f, d as p, l as m, o as h, s as g } from "./section-panel-ui-state-QV2-K89y.js";
import { n as _ } from "./copilot-eventbus-tR06exIW.js";
import { n as v, r as y } from "./copilot-ui-state-DjlBBpyf.js";
import { r as b, t as x } from "./stats-BSuRK33k.js";
import { t as S } from "./directive-CZ105jp5.js";
import { a as C, d as w, f as T, o as E } from "./copilot-error-handler-DrF5aMdz.js";
import { n as D, t as O } from "./copilot-stored-machine-state-DS3t0BPl.js";
import { a as k, i as A } from "./copilot-shortcuts-BbaE8iMt.js";
import { n as j, t as M } from "./base-panel-DSO7zZ78.js";
import { n as N, r as P, t as F } from "./lit-renderer-Boo1dpPY.js";
...
e((() => {
	g(), s(), a(), i(), w(), z(), A(), V(), O(), y(), j(), t(), u(), E(), x(), h(), H = class extends M {
		constructor(...e) {
			super(...e), this.selectedTab = 0, this.activationShortcutEnabled = D.isActivationShortcut(), this.aiUsage = D.isAIUsageAllowed(), this.hideCopilotRequestOngoing = !1, this.hideCopilotDialogVisible = !1, this.sizeItems = [{
				label: "Default",
				value: "default"
			}, {
				label: "Compact",
	...
	}, f([m()], H.prototype, "selectedTab", void 0), f([m()], H.prototype, "activationShortcutEnabled", void 0), f([m()], H.prototype, "aiUsage", void 0), f([m()], H.prototype, "hideCopilotRequestOngoing", void 0), f([m()], H.prototype, "hideCopilotDialogVisible", void 0), H = f([p("copilot-settings-panel")], H), U = {
		header: "Settings",
		tag: n.SETTINGS
