...
import { $ as t, B as n, F as r, G as i, H as a, I as o, J as s, L as c, N as l, R as u, U as d, V as f, W as p, X as m, Y as h, Z as g, et as _, j as v, k as y } from "./icons-DoMJjP82.js";
import { c as b, h as x, l as S, m as C, s as w, u as T } from "./dom-utils-BVcG3axi.js";
import { n as E, t as D } from "./copilot-eventbus-tR06exIW.js";
import { i as O, o as k } from "./copilot-error-handler-DrF5aMdz.js";
import { n as A, r as j } from "./copilot-notification-BnxWYvla.js";
//#region frontend/copilot/shared/copilot-storage.ts
var M, N, P = e((() => {
	M = "copilot-conf", N = class {
...
var Q, $, ee = e((() => {
	s(), J(), l(), b(), k(), c(), A(), _(), E(), Q = /* @__PURE__ */ new WeakMap(), $ = class {
		constructor() {
		...
		async isInitializedInProjectSources(e) {
			let t = y(e);
			if (!t) return !1;
			let { nodeId: n, uiId: r } = t;
			if (!this.flowNodesInSource[r]) {
				let e = await u("copilot-get-component-source-info", { uiId: r }, (e) => e.data);
				e.error && O("Failed to get component source info", e.error), this.flowCustomComponentData[r] = e.customComponentResponse, this.flowNodesInSource[r] = new Set(e.nodeIdsInProject), this.componentDragDropApiInfosMap[r] = e.dragDropApiInfos;
			}
			return this.flowNodesInSource[r].has(n);
		}
		async addToTree(e, n) {
			...
			if (n) o && (o.parent = n, n.children ||= [], n.children.push(o));
				...
				if (!o) {
					if (!(e instanceof Element) && h(e)) return j({
						type: t.WARNING,
...
//#endregion
export { N as a, K as i, ee as n, P as o, J as r, $ as t };
