...
import { _ as n, g as r } from "./icons-DoMJjP82.js";
import { l as i, n as a, s as o } from "./consts-nuhLqR24.js";
import { n as s, t as c } from "./section-panel-ui-state-QV2-K89y.js";
...
function f() {
	h().publicPluginsState === "NOT_INITIALIZED" && (g.push(import("./copilot-log-plugin-BFrZINqp.js")), g.push(import("./copilot-info-plugin-CHihrFyl.js")), g.push(import("./copilot-features-plugin-DrVuOOqa.js")), g.push(import("./copilot-feedback-plugin-Bf9ai09O.js")), g.push(import("./copilot-settings-panel-DtHomxDK.js")), g.push(import("./copilot-impersonator-plugin-BGpilWfH.js")), g.push(import("./copilot-development-setup-user-guide-BmVSjvVU.js")), v = !0, h().setPublicPluginsState("IMPORTED"));
}
function p() {
...
async function S() {
	return (await import("./copilot-focus-trap-CkZGs-mH.js")).copilotFocusTrap;
}
function C() {
	return import("./typescript-BSDZTnFu.js").then((t) => /* @__PURE__ */ e(t.default, 1));
}
var w = t((() => {}));
//#endregion
