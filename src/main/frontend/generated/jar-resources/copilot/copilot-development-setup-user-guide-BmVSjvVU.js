...
import { L as t, R as n, it as r, n as i, o as a, r as o, t as s, u as c, ut as l } from "./icons-DoMJjP82.js";
import { a as u, c as d, i as f, l as p, o as m } from "./consts-nuhLqR24.js";
import { a as h, d as g, i as _, l as v, n as y, o as b, r as x, s as S, t as C } from "./section-panel-ui-state-QV2-K89y.js";
import { n as w, t as T } from "./copilot-eventbus-tR06exIW.js";
import { i as E, n as D } from "./copilot-modes-DB35EeBK.js";
import { n as O, r as k } from "./copilot-ui-state-DjlBBpyf.js";
import { i as A, o as j } from "./copilot-error-handler-DrF5aMdz.js";
import { n as M, t as N } from "./early-project-state-D-4_8bD-.js";
import { i as P, o as F, s as I, t as L } from "./copilot-development-setup-user-guide-utils-CaomGuMc.js";
import { n as R, t as z } from "./base-panel-DSO7zZ78.js";
...
//#endregion
e((() => {
	i(), S(), C(), o(), r(), p(), k(), I(), w(), j(), t(), M(), E(), R(), _(), b(), H = "https://github.com/JetBrains/JetBrainsRuntime/releases", U = "Download complete", W = (V = class extends z {
		createRenderRoot() {
			return this;
		}
		constructor() {
    ...
    `;
		...
		renderPluginSection(e) {
			...
			let i = e.idePluginInstalled ? s.checkCircle : s.warning;
			return c`
      <vaadin-details
        theme="reverse"
    ...
    `;
		...
		renderHotswapSection(e) {
			...
			if (!t) return a;
			let n = P(), r = F(), i, o;
			n === "success" ? (i = s.checkCircle, o = "Java Hotswap is enabled") : n === "warning" ? (i = s.warning, o = "Java Hotswap is not enabled") : n === "error" && (i = s.warning, o = "Java Hotswap is partially enabled");
    ...
    `;
      ...
      <vaadin-details theme="reverse" .opened="${!t}">
        ...
        <div class="flex flex-col gap-2 pb-2 px-2 text-secondary">
          ...
          <ul class="m-0 ps-4">
            ${e.intellij && B("1.3.0", O.idePluginState?.version) ? c` <li>Upgrade to the latest IntelliJ plugin</li>` : a}
