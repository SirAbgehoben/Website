...
import { $ as r, C as i, D as a, J as o, L as s, M as c, N as l, R as u, et as d, h as f, i as p, it as m, lt as h, n as g, o as _, r as v, st as y, t as b, u as x, v as ee, x as te, y as ne, z as S } from "./icons-DoMJjP82.js";
import { l as re, o as ie, t as C } from "./consts-nuhLqR24.js";
import { c as ae, r as oe } from "./dom-utils-BVcG3axi.js";
import { a as se, o as ce } from "./copilot-tree-impl-Dw-Rk5hX.js";
import { a as w, c as le, d as ue, i as de, l as T, n as E, o as fe, r as pe, s as me, t as he, u as ge } from "./section-panel-ui-state-QV2-K89y.js";
import { n as _e, t as D } from "./copilot-eventbus-tR06exIW.js";
import { d as ve, i as ye, l as be, n as xe, t as Se, u as Ce } from "./copilot-modes-DB35EeBK.js";
import { n as O, r as we, t as Te } from "./copilot-ui-state-DjlBBpyf.js";
import { r as Ee, t as De } from "./stats-BSuRK33k.js";
import { a as Oe, c as ke, i as Ae, l as je, n as Me, o as Ne, r as Pe, s as Fe, t as Ie, u as Le } from "./copilot-userinfo-BkbAv3uw.js";
import { t as Re } from "./directive-CZ105jp5.js";
import { d as ze, f as Be } from "./copilot-error-handler-DrF5aMdz.js";
...
import { i as qe, o as Je, s as Ye } from "./copilot-development-setup-user-guide-utils-CaomGuMc.js";
import { n as Xe, t as Ze } from "./track-active-mode-event-De-IUJBi.js";
import { n as Qe, r as $e, t as et } from "./lit-renderer-Boo1dpPY.js";
import { n as tt, r as nt, t as rt } from "./copy-to-clipboard-CqdvI-Lu.js";
...
var at, ot, st, ct, lt, ut = t((() => {
	...
	de(), me(), he(), v(), tt(), Ct(), g(), ze(), we(), ae(), re(), m(), fe(), wt = class extends pe {
		constructor(...e) {
		...
		connectedCallback() {
			...
			}), this.observeDisposer = y(E.getCustomPanelHeaderMap(), () => {
		...
		render() {
			return x`
      ${nt(this.openedPanelConfigurationsSorted, (e) => e.tag, (e) => x`<vaadin-dialog
            draggable
            modeless
            id="${e.tag}-dialog"
            waits-positioning
            ...
            @dragged="${(t) => {
				...
				if (!n) return;
				let r = t.currentTarget, i = r.getBoundingClientRect(), a = {
				...
				r.setAttribute("top", `${o.top}`), r.setAttribute("left", `${o.left}`), E.updatePanel(n.tag, { position: o });
			}}"
            @mouseenter="${(e) => {
				let t = e.target;
            ...
            ${bt(() => x`
                <h2 class="font-bold me-auto my-0 text-xs truncate uppercase draggable" id="${e.tag}-title">
                  ${E.getPanelHeader(e)}
                  ${e.experimental ? x`<vaadin-icon slot="suffix" .svg="${b.experiment}"></vaadin-icon>
                ...
                ${e.helpUrl ? x`<vaadin-button
                      ...
                      theme="icon tertiary">
                      <vaadin-icon .svg="${b.help}"></vaadin-icon>
				...
				t?.requestClose ? t.requestClose(() => E.closePanel(e.tag)) : E.closePanel(e.tag);
                  ...
                  @mousedown="${(e) => e.stopPropagation()}"
                  theme="icon tertiary">
                  <vaadin-icon .svg="${b.close}"></vaadin-icon>
                  <vaadin-tooltip slot="tooltip" text="Close"></vaadin-tooltip>
                </vaadin-button>
              `, [this.panelHeaderUpdated])}
            ${yt(() => x`<div class="h-full w-full">${Be(`<${e.tag}></${e.tag}>`)}</div>`, [])}
            ${e.footerActionsTag ? xt(() => x`
...
var At = t((() => {
	_e(), o(), l(), De(), we(), Dt(), s(), Ue(), d(), D.on("undoRedo", (e) => {
		let t = {
			files: kt(e),
			uiId: c()
...
var Mt, Nt = t((() => {
	de(), me(), we(), v(), tt(), Ue(), i(), g(), d(), _e(), fe(), Mt = class extends pe {
		createRenderRoot() {
			return this;
		}
		connectedCallback() {
      ...
      <div
        ...
        <div
          ...
          <vaadin-icon
            ...
            .svg="${e.type === r.WARNING || e.type === r.ERROR ? b.warning : b.info}"></vaadin-icon>
          <div class="flex flex-col flex-1">
            <h2 class="m-0 pe-8 text-sm">${e.message}</h2>
            <div
...
var It, Lt, Rt = t((() => {
	if (_e(), we(), It = /* @__PURE__ */ e(Ne(), 1), Ue(), d(), Oe(), Ke(), Ye(), De(), ye(), i(), Lt = (0, It.default)(async () => {
		await Ae();
	...
	me(), v(), Ct(), g(), ye(), fe(), zt = class extends p {
		constructor(...e) {
      ...
      ${bt(() => x`
          ...
          <vaadin-icon .svg="${b.sparkles}"></vaadin-icon>
        `)}
      ${yt(() => x`
          ...
          <div class="list-preview-container">
            <div class="left-menu">
              ...
              <vaadin-list-box
                ...
                ${this.exceptionReport?.items.map((e, t) => x` <vaadin-item>
                      <input
                        type="checkbox"
	...
	_e(), d(), v(), i(), we(), g(), Ue(), D.on("copilot-project-compilation-error", (e) => {
		if (e.detail.error) {
			let t;
			if (e.detail.files && e.detail.files.length > 0) {
				let n = O.idePluginState?.supportedActions?.includes("undo") ? x`
            <vaadin-button
              @click="${(t) => {
              ...
              theme="primary">
              <vaadin-icon slot="prefix" .svg="${b.undo}"></vaadin-icon>
              Undo Last Change
            </vaadin-button>
          ` : _;
				t = ne(x`
        ...
        <ul class="list-none mb-0 mt-2 p-0">
          ${e.detail.files.map((e) => x` <li>
                <vaadin-button
                  @click="${() => {
					D.emit("show-in-ide", { javaSource: { absoluteFilePath: e.path } });
				}}"
                  theme="tertiary">
                  <vaadin-icon slot="prefix" .svg="${b.code}"></vaadin-icon>
                  ${e.name}
                </vaadin-button>
              </li>`)}
        </ul>
	...
	v(), me(), qt = /* @__PURE__ */ e(rt(), 1), g(), fe(), Jt = class extends p {
		constructor(...e) {
      ...
      theme="icon tertiary">
      <vaadin-icon .svg="${b.fileCopy}"></vaadin-icon>
...
var un = t((() => {
	_e(), d(), i(), v(), Yt(), sn(), D.on("endpoint-request", (e) => {
		...
		D.emit("log", {
			...
			expandedMessage: ne(x`Called endpoint ${t.endpoint}.${t.method} with parameters
		...
		i === 200 ? (n.details = `Response: ${ln(t)}`, n.expandedDetails = ne(x`Response: <code class="codeblock"><copilot-copy></copilot-copy>${ln(t)}</code>`)) : (n.details = `Error: ${i} ${tn(i)}`, n.type = r.ERROR), D.emit("update-log", {
			id: cn(e.detail),
			...n
		});
	});
	...
	v(), me(), g(), _e(), Le(), Fe(), i(), fe(), fn = class extends CustomEvent {
		...
		render() {
			return this.iconHidden ? this.linkHidden ? _ : this.renderContent(this.renderAnchor()) : this.linkHidden ? this.renderContent(this.renderIcon()) : this.renderContent([this.renderIcon(), this.renderAnchor()]);
		}
		renderContent(e) {
      ...
      <vaadin-button
        ...
        <vaadin-icon .svg="${b.code}"></vaadin-icon>
    ...
    `;
		...
		renderTooltip(e) {
			return x`<vaadin-tooltip for="${e}" text="${this.tooltipText ?? `Open ${this.getFileName()} in IDE`}" position="top-start"></vaadin-tooltip>`;
		}
		getFileName() {
...
var sr, cr, lr, ur, dr, fr, pr, mr, hr, gr, B, _r, vr, yr, br, V, H, U, W, G, xr, Sr, K, Cr, wr, q, Tr, Er, Dr, J, Or, kr, Ar, jr, Y, Mr, Nr, Pr, Fr, Ir, Lr, Rr, zr, Br, Vr, X, Hr, Ur, Wr, Gr, Kr, qr, Jr, Yr, Xr, Zr, Qr, $r, ei, ti, ni, ri, Z, ii, ai, oi, si, ci, li, ui, di, fi, pi = t((() => {
	...
	m(), He(), we(), hi = .4, gi = class {
		constructor() {
			this.handlers = [], this.toolbarConnected = (e) => {
				this.toolbar = e, this.reactionDisposer = h(() => Ve.getToolbarExpandMode(), (e, t) => {
		...
		onActivate(e) {
			this.toolbar = e, this.activeModeReactionDisposer = h(() => O.activeMode, () => {
		...
		onActivate(e) {
			this.toolbar = e, e.addEventListener("mouseover", this.handleMouseOverEvent), e.addEventListener("mouseleave", this.handleMouseLeaveEvent), this.activeModeReactionDisposer = h(() => O.activeMode, () => {
		...
		onActivate(e) {
			this.toolbar = e, e.addEventListener("click", this.handleClick), requestAnimationFrame(() => {
				this.updateByCopilotActiveMode();
			}), this.activeModeReactionDisposer = h(() => O.activeMode, () => {
				this.updateByCopilotActiveMode();
			}, { fireImmediately: !0 });
		}
		onDeactivate(e) {
	...
	me(), de(), we(), v(), he(), tt(), g(), pi(), ye(), Ce(), Ie(), ce(), Ci(), He(), Ze(), fe(), Ei = (wi = class extends pe {
      ...
      <div class="flex" id="common-mode-panel-icon-container">
        <vaadin-button
          ...
          <vaadin-icon .svg="${b.moreVert}"></vaadin-icon>
          <vaadin-tooltip slot="tooltip" text="Open menu"></vaadin-tooltip>
        </vaadin-button>
        <vaadin-popover
          @opened-changed="${(e) => {
				this.expandModeHandler.devToolsPopoverOpenClosedChanged(e.detail.value), e.detail.value && !this.devToolsDataLoaded && (this.devToolsDataLoading = !0, import("./copilot-devtools-BqIkm4w4.js").then(() => {
    ...
    `;
      ...
      <vaadin-radio-group
        ...
        ${nt(this.modeRadioButtonItems, (e) => e.value, (e) => x`
    ...
    `;
		...
		renderModeButtonIcon(e) {
			return e.value === "play" ? x`
      <span aria-hidden="true" class="toolbar-play-mode-icon-stack">
        <vaadin-icon class="toolbar-play-mode-icon--play" .svg="${b[e.icon]}"></vaadin-icon>
        <vaadin-icon class="toolbar-play-mode-icon--vaadin" .svg="${b.vaadin}"></vaadin-icon>
      </span>
    ` : x`<vaadin-icon .svg="${b[e.icon]}"></vaadin-icon>`;
		}
		renderPanelIcon(e) {
      ...
      <vaadin-button
        ...
        <vaadin-icon .svg="${b[e.toolbarOptions.iconKey]}"></vaadin-icon>
        <vaadin-tooltip
          slot="tooltip"
          text="${e.header}${E.attentionRequiredPanelTag === e.tag ? " – Attention Required" : ""}"></vaadin-tooltip>
        ${E.attentionRequiredPanelTag === e.tag ? x`<span
                aria-hidden="true"
...
var Fi = t((() => {
  ...
  `, this.tryAcquireLicense = () => {
	...
	Da = /* @__PURE__ */ e(Ea(), 1), He(), Ue(), d(), s(), re(), i(), v(), we(), Oa = (e) => Da.default.valid(e) ?? Da.default.valid(Da.default.coerce(e)), window.Vaadin.copilot.eventbus.on("serverInfo", (e) => {
		...
		u(`${ie}get-release-note-url`, { version: i }, (e) => {
			...
			if (!t.error && t.url) if (n) {
				...
				O.setProjectVersionReleaseNoteInfo({
					...
					details: ne(x`<a class="ahreflike" href="${t.url}" target="_blank">Click here to open release notes!</a>`)
